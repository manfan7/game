...
export class View {
    constructor() {
        document.addEventListener('keyup', (e) => {
            ...
            const secDirect = directionsSecondPlayer[e.code]
            if (direction) {
                this?.onPlayerMoove(1, direction)

            } else if (secDirect) {
                this?.onPlayerMoove(2, secDirect)
            }
...
class HeaderComponent {
    ...
    render() {
        ...
        addButton.addEventListener('click', () => {
            ...
            if (!this.#props.dto.players.find(item => item.id === 2) && this.#props.dto.status !== GameStatus.inProgress) {
